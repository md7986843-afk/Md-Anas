export const PERSONAL_INFO = {
  ...
  email: "md7986843@gmail.com",
  phone: "01881559754",
  location: "Bangladesh, Dhaka",
  availability: "24 Hours",
  experience: "WordPress Web Development. 2 years experience",
  languages: "English, Bengali",
  personalImage: "https://dev-newsiteeeee.pantheonsite.io/wp-content/uploads/2026/05/678966578_122110320465081027_3338261488890813856_n.jpg",
  socials: {
    facebook: "https://www.facebook.com/profile.php?id=61582430826930",
    linkedin: "https://www.linkedin.com/in/dev-anas-2ab740409/",
    instagram: "https://www.instagram.com/devanas247/",
    whatsapp: "https://wa.me/8801881559754",
    github: "#",
    behance: "#"
  }
};
...
export const SERVICES = [
  {
    ...
    description: "Creating stunning, high-converting WordPress sites tailored to your brand identity.",
    icon: "Layout"
  },
  {
    title: "Elementor Website Design",
    description: "Expert in building complex layouts and custom designs using Elementor Page Builder.",
    icon: "Square"
  },
  {
    title: "WooCommerce Development",
    description: "Professional eCommerce solutions to help you sell products and scale your business.",
    icon: "ShoppingBag"
  },
  {
    title: "Speed Optimization",
    description: "Optimizing your site for lightning-fast load times and perfect Core Web Vitals.",
    icon: "Zap"
  },
  {
    title: "SEO Optimization",
    description: "Improving your search engine rankings and increasing organic traffic to your site.",
    icon: "Search"
  },
  {
    title: "Bug Fix & Customization",
    description: "Troubleshooting issues and adding custom features to improve site functionality.",
    icon: "Wrench"
  }
];
...
export const BLOGS = [
  {
    title: "Best WordPress Plugins in 2026",
    category: "WordPress",
    date: "May 20, 2024",
    readTime: "5 min read",
...
export const PROCESS = [
  { step: "01", title: "Discussion", description: "Analyzing your requirements and business goals." },
  { step: "02", title: "Planning", description: "Mapping out the user flow and site architecture." },
  { step: "03", title: "Design", description: "Creating a visually stunning and modern interface." },
